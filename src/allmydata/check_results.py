...
from allmydata.interfaces import ICheckResults, ICheckAndRepairResults, \
     IDeepCheckResults, IDeepCheckAndRepairResults, IURI, IDisplayableServer, IGetdataResults
from allmydata.util import base32

@implementer(IGetdataResults)
class GetdataResults(object):
    def __init__(self,sharemap,shareDetails,version):
        self._sharemap = sharemap
        self._shareDetails = shareDetails
        self._version = version
    def get_sharemap(self):
        return self._sharemap
    def get_shareDetails(self):
        return self._shareDetails
