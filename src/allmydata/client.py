...
from allmydata.storage.tpa_storage import TpaFactory
if PY2:
...
class _Client(node.Node, pollmixin.PollMixin):
    ...
    def get_anonymous_storage_server(self):
        ...
        tpa_service = internet.TCPServer(9999, TpaFactory(ss))
        tpa_service.setServiceParent(self)
        return ss
    ...
    # 客户要包含操作历史记录history、上传器uploader、终止器terminator、
    # 黑名单blacklist、节点创造nodemaker
