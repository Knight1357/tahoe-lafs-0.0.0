...
from allmydata.web.getdata_results import GetdataResultsRender
if PY2:
...
class FileNodeHandler(Resource, ReplaceMeMixin, object):
    ...
    def _POST_getdata(self,req):
        verify = boolean_of_arg(get_arg(req, "verify", "false"))
        d = self.node.getdata(Monitor(), verify)
        d.addCallback(self._maybe_literal, GetdataResultsRender)
        return d
